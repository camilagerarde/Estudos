...
class ArvoreBinaria {
  ...
  private void exibirEsquerdo(BIntNo arvore) {
    if (arvore != null) {
      exibirEsquerdo(arvore.esq);
  ...
  private void exibirDireito(BIntNo arvore) {
    if (arvore != null) {
      exibirDireito(arvore.dir);
      System.out.println(arvore.valor);
    }
  }
...
class Main {
  public static void main(String args[]) {
    ...
    for (int i = 0; i < 5; i++) {
      arvore.inserirNo(Integer.parseInt(JOptionPane.showInputDialog("Digite um número inteiro")));
    }
