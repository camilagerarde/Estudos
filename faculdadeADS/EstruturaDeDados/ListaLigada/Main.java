class Main {
  public static void main(String arg[]) {
    No primeiroNo = new No(43);
    No segundoNo = new No(89);
    No terceiroNo = new No(55);
    ListaLigada listaLigada = new ListaLigada();

    listaLigada.ElementoInicio();
    listaLigada.InserirInicio(primeiroNo);
    listaLigada.InserirFinal(segundoNo);
    listaLigada.InserirMeio(terceiroNo,2);
    listaLigada.ElementoFinal();
    listaLigada.MostrarLista();
    listaLigada.Remover(55);
    listaLigada.Remover(43);
    listaLigada.Remover(7);
    listaLigada.Remover(89);
